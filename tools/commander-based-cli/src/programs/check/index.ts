...
const templatePackageJson = require('../../../../../modules/typescript/templates/ts-updraft-module/package.json')
...
const printResults = (results: RulesResult[]) => {
  ...
  results.filter(filterStatus(STATUS.PASSED)).forEach(printResult)
  console.log('')
...
const checkHandler = (modulePath = '.', opts) => {
