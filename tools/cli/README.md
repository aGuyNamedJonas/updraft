...
@updraft/cli/0.0.9 darwin-x64 node-v14.3.0
...
_See code: [lib/commands/check.js](https://github.com/aGuyNamedJonas/updraft/blob/v0.0.9/lib/commands/check.js)_
...
_See code: [lib/commands/doc.js](https://github.com/aGuyNamedJonas/updraft/blob/v0.0.9/lib/commands/doc.js)_
...
_See code: [lib/commands/init.js](https://github.com/aGuyNamedJonas/updraft/blob/v0.0.9/lib/commands/init.js)_
...
_See code: [lib/commands/publish.js](https://github.com/aGuyNamedJonas/updraft/blob/v0.0.9/lib/commands/publish.js)_
...
_See code: [lib/commands/templates.js](https://github.com/aGuyNamedJonas/updraft/blob/v0.0.9/lib/commands/templates.js)_
<!-- commandsstop -->
